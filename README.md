...
<p align="center">
  ...
  <a href="https://golang.org/"><img alt="go" src="https://img.shields.io/badge/Go-1.26.1%2B-00ADD8?style=flat-square&logo=go"></a>
...
- 首次部署不会预置默认管理员账号
- 当 `users` 表为空时，**第一个注册成功的账号会自动成为超管(admin)**
- 建议首次启动后立即注册你的管理员邮箱，并妥善保管密码
